...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyimapsync-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15424&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyimapsync-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyimapsync` can be installed with:

```
conda install pyimapsync
```

It is possible to list all of the versions of `pyimapsync` available on your platform with:
